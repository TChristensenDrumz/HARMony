...
updateCanvas() {
    ...
    class Player{
        constructor(img, scale, width, height, playerX, playerY, animation, lastMove, playerHealth, attackLength, playerHurt, playerHurtLength){
            this.img = img
            this.scale = scale;
            this.width = width;
            this.height = height;
            ...
            this.playerHurtLength = playerHurtLength; 
        }
        drawFrame(frameX, frameY){
            ctx.drawImage(this.img,
                frameX * this.width, frameY * this.height, this.width, this.height,
    ...
    //construct player
    const playerOne = new Player(player, 1.5, 24, 24, 600, 360, [], 0, 100, 0, )
