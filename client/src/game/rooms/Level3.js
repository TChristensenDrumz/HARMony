...
import BG from "../assets/maps/pop/popLevel3.png"
...
updateCanvas() {
    ...
    const enemy3 = new Enemy(imageObj2,  Math.random()*1100, Math.random()*620, 1, [], 100, 10, 0)
    const enemy4 = new Enemy(imageObj2,  Math.random()*1100, Math.random()*620, 1, [], 100, 10, 0)
    const enemy5 = new Enemy(imageObj2,  Math.random()*1100, Math.random()*620, 1, [], 100, 10, 0)
    const enemy6 = new Enemy(imageObj2,  Math.random()*1100, Math.random()*620, 1, [], 100, 10, 0)
    const enemy7 = new Enemy(imageObj2,  Math.random()*1100, Math.random()*620, 1, [], 100, 10, 0)
    ...
    function move(cycleLoop, cycleLoop2, cycleLoop3, cycleLoop4, cycleLoop5, cycleLoop6, cycleLoop7, cycleLoop8, cycleLoop9){
        ...
        enemy3.drawFrame2(cycleLoop5[currentLoopIndex], 0, 0, 0);
        enemy4.drawFrame2(cycleLoop6[currentLoopIndex], 0, 0, 0);
        enemy5.drawFrame2(cycleLoop7[currentLoopIndex], 0, 0, 0);
        enemy6.drawFrame2(cycleLoop8[currentLoopIndex], 0, 0, 0);
        enemy7.drawFrame2(cycleLoop9[currentLoopIndex], 0, 0, 0);
    ...
    const step = () => {
        ...
        switch(true){
            ...
            move(animation, enemy.enemyAnimation, enemy1.enemyAnimation, enemy2.enemyAnimation, enemy3.enemyAnimation, enemy4.enemyAnimation, enemy5.enemyAnimation, enemy6.enemyAnimation, enemy7.enemyAnimation)
    ...
    function init() {
        ...
        requestAnimationFrame(enemy6.step2)
        requestAnimationFrame(enemy7.step2)
...
render() {
    ...
    return (
        ...
        style={styles}></canvas>
        {this.state.roomChange ? <Redirect to="/harmony/bossroom"/> : <Redirect to="/harmony/level3" />}
        </div>
