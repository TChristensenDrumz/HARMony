...
import BG from "../assets/maps/pop/popLevel2.png"
...
updateCanvas() {
    ...
    function move(cycleLoop, cycleLoop2, cycleLoop3, cycleLoop4, cycleLoop5, cycleLoop6){
    ...
    const step = () => {
        ...
        switch(true){
            ...
            move(animation, enemy.enemyAnimation, enemy1.enemyAnimation, enemy2.enemyAnimation, enemy3.enemyAnimation, enemy4.enemyAnimation)
...
render() {
    ...
    return (
        ...
        style={styles}></canvas>
        {this.state.roomChange ? <Redirect to="/harmony/level3"/> : <Redirect to="/harmony/level2" />}
        </div>
